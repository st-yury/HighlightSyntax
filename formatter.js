    ...
    class Highlighter {
        ...
        static aSingleSpanOpeningTagRegExp = /<span\s+style="color:\s*#([0-9a-fA-F]{6}|[0-9a-fA-F]{3})"\s*>/g;
        static aSingleSpanClosingTag = "</span>";

        static getClassHeaders(theCode) {
        ...
        static getClassName(classHeader) {
        ...
        static isInside(openTag, closeTag, str, index) {
        ...
        static replaceTheTypeName(theCode, strPattern) {
        ...
        static highlightCustomTypes(theCode) {
        ...
        static highlightStdKeywords(theCode) {
        ...
        static highlightComments(theCode) {
        ...
        static highlightStrings(theCode) {
        ...
        static highlightNonStaticMethods(theCode) {
        ...
        static highlightStaticMethods(theCode) {
            ...
            if(beforeMethods.length > 0) {
                ...
                for (let i = 0; i < beforeMethods.length - 1; i++) {
                ...
                theUpdatedCode += `<beforeMethodName>${theCode.substring(beforeMethods[beforeMethods.length - 1].startIndex, beforeMethods[beforeMethods.length - 1].endIndex)}</beforeMethodName>`;
    ...
    function colorize(theCode) {
        ...
        theCode = Highlighter.specialCharsShielding(theCode);
        theCode = Highlighter.highlightStrings(theCode);
        theCode = Highlighter.highlightComments(theCode);
        theCode = Highlighter.highlightStdKeywords(theCode);
        theCode = Highlighter.highlightCustomTypes(theCode);
        theCode = Highlighter.highlightNonStaticMethods(theCode);
        theCode = Highlighter.highlightStaticMethods(theCode);
    ...
    function convert() {
        ...
        // you didn't paste anything into the C# code window
        if (codeToWorkWith === "") {
